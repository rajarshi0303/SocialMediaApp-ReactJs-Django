...
const apiUrl = "http://localhost:8000/addpost/";
  ...
  const handleVideoUpload = (event) => {
    ...
    video.onloadedmetadata = () => {
      if (video.duration > 300) {
        ...
        alert("Maximum video duration exceeded (5 minutes)");
        // Perform any additional actions (e.g., clear the file input, display an error message, etc.)
        event.target.value = null; // Clear the file input to allow selecting a different video
      } else {
        // Video duration is within the allowed limit
        setSelectedVideo(URL.createObjectURL(file));
        console.log(file);
        // Perform your desired actions here (e.g., upload the video, save it in state, etc.)
        setContent(file);
  ...
  return (
    <div className="flex items-center">
      ...
      >
        ...
        <p className="mt-6 flex justify-center mx-auto text-lg font-semibold text-gray-500 lg:text-xl">
          Post Privacy
        </p>
