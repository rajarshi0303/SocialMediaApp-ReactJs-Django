...
import { statusAtom } from "./CreateAccount";
...
export default function Register() {
  ...
  useEffect(() => {
    if (user.length === 0) {
      return; // Skip the code inside useEffect if user is an empty array
    }
    const fetchData = async () => {
      // Code to run if user is not an empty array
      try {
      ...
      <div class="flex flex-col w-full items-center justify-center h-screen">
        <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-3xl shadow-2xl dark:bg-gray-800 lg:max-w-4xl">
          <div
            ...
            style={{
              backgroundImage: "url('/public/Images/Signup/Signup.png')",
            }}
          ></div>
          <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <p className="mt-3 text-xl text-center text-gray-600 dark:text-gray-200">
              Welcome To <span className="text-teal-600">Opinext!</span>
              <br></br>Join Now!
            </p>
